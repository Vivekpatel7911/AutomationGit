...
public class BaseTests implements ITestListener {
    ...
    public void setUp(){
        ...
        basePage.launchBrowser(EnvPropertiesLoader.browserName);
    }


    @AfterMethod
    public void tearDown(ITestResult context) throws IOException {
//        basePage.captureScreenshots(context.getTestName());
//        basePage.captureScreenshotAsBase64();
    ...
    public void onFinish(ITestContext context) {ExtentReporter.mainReport.flush();}
